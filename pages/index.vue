<template>
  <div id="home-content"
    class="w-full h-auto bg-gray-900 p-0 m-0 flex flex-col bg-gradient-to-t from-purple-800 via-gray-800 to-gray-900 "
  >
    <div class="top-0 w-full">
      <NavBar />
    </div>
    <div class="mt-14 flex items-center justify-center w-11/12 h-3/5 mx-auto">
      <Header />
    </div>
    <hr class="mx-auto w-5/6 border-gray-700 my-1" />
    <div class="mx-auto font-medium text-gray-200 mt-10 text-sm w-full flex">
      <div class="w-1/3 text-center">
        <span class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-tr-lg rounded-bl-lg px-4 py-2 shadow-xl">
          What i do
        </span>
      </div>
      <div class="w-1/3 text-center">
        <span class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-800 rounded-tr-lg rounded-bl-lg px-4 py-2">
          Check Out My Projects!
        </span>
      </div>
      <div class="w-1/3 text-center pr-20">
        <span class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-800 rounded-tr-lg rounded-bl-lg px-4 py-2">
          Experience
        </span>
      </div>
    ...
    <Projects />
    <hr class="mx-auto w-5/6 border-gray-700 my-10" />
    <div id="skill-content" class="flex items-center justify-center w-full">
      <Skills />
    </div>
    <hr class="mx-auto w-5/6 border-gray-700 my-10" />
    <div id="about-content" class="flex items-center justify-center w-full">
      <About />
    </div>
    <div id="portfolio-content" class="flex items-center justify-center w-full">
      <Portfolio />
    </div>
    <div id="contact-content" class="bottom-0 mt-16 w-full bg-black h-16 py-10">
      <div>
